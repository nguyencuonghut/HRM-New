...
export class ContractService {
  ...
  // Approval workflow
  static submitForApproval(id, opts={}) { router.post(`/contracts/${id}/submit-for-approval`, {}, { preserveState:true, preserveScroll:true, ...opts }); }
  ...
  static recall(id, opts={}) { router.post(`/contracts/${id}/recall`, {}, { preserveState:true, preserveScroll:true, ...opts }); }
