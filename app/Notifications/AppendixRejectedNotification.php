...
class AppendixRejectedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ->subject('Phụ lục hợp đồng đã bị từ chối')
            ->greeting('Xin chào ' . $notifiable->name . ',')
            ->line('Phụ lục hợp đồng của bạn đã bị từ chối.')
        ...
        return $mail
            ...
            ->line('Vui lòng kiểm tra và chỉnh sửa phụ lục nếu cần.');
    }
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => 'Phụ lục ' . $this->appendix->appendix_no . ' (' . $appendixType . ') đã bị ' . $this->rejector->name . ' từ chối',
