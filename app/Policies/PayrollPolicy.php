...
class PayrollPolicy
{
    ...
    {
        return $user->hasPermissionTo('view payroll');
    }
    ...
    {
        return $user->hasPermissionTo('create payroll');
    }
    ...
    {
        return $user->hasPermissionTo('edit payroll');
    }
    ...
    {
        return $user->hasPermissionTo('delete payroll');
    }
    ...
    {
        return $user->hasPermissionTo('process payroll');
    }
