...
class ContractDocxTemplateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            [
                'id'                => Str::uuid(),
                'name'              => 'Mẫu HĐ Không xác định thời hạn (DOCX)',
                'type'              => 'INDEFINITE',
                'engine'            => 'DOCX_MERGE',
                'body_path'         => 'templates/contracts/indefinite.docx',
                'content'           => null,
                'placeholders_json' => json_encode($docxPlaceholders, JSON_UNESCAPED_UNICODE),
                'is_default'        => true,
                'is_active'         => true,
            ...
            [
                'id'                => Str::uuid(),
                'name'              => 'Mẫu HĐ Thời vụ (DOCX)',
                'type'              => 'SEASONAL',
                'engine'            => 'DOCX_MERGE',
                'body_path'         => 'templates/contracts/seasonal.docx',
                'content'           => null,
                'placeholders_json' => json_encode($docxPlaceholders, JSON_UNESCAPED_UNICODE),
                'is_default'        => true,
                'is_active'         => true,
            ...
            [
                'id'                => Str::uuid(),
                'name'              => 'Mẫu HĐ Dịch vụ (DOCX)',
                'type'              => 'SERVICE',
                'engine'            => 'DOCX_MERGE',
                'body_path'         => 'templates/contracts/service.docx',
                'content'           => null,
                'placeholders_json' => json_encode($docxPlaceholders, JSON_UNESCAPED_UNICODE),
                'is_default'        => true,
                'is_active'         => true,
            ...
            [
                'id'                => Str::uuid(),
                'name'              => 'Mẫu HĐ Thực tập (DOCX)',
                'type'              => 'INTERNSHIP',
                'engine'            => 'DOCX_MERGE',
                'body_path'         => 'templates/contracts/internship.docx',
                'content'           => null,
                'placeholders_json' => json_encode($docxPlaceholders, JSON_UNESCAPED_UNICODE),
                'is_default'        => true,
                'is_active'         => true,
            ...
            [
                'id'                => Str::uuid(),
                'name'              => 'Mẫu HĐ Bán thời gian (DOCX)',
                'type'              => 'PARTTIME',
                'engine'            => 'DOCX_MERGE',
                'body_path'         => 'templates/contracts/parttime.docx',
                'content'           => null,
                'placeholders_json' => json_encode($docxPlaceholders, JSON_UNESCAPED_UNICODE),
                'is_default'        => true,
                'is_active'         => true,
